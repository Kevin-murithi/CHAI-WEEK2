    ...
    <Card title={<span className="flex items-center gap-2"><OverviewIcon className="w-4 h-4" /> <span>Field Health Overview</span></span>} className="mb-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {data.fieldHealthScore && (
          <div className="group rounded-xl ring-1 ring-white/5 bg-gradient-to-br from-slate-900/70 to-slate-800/50 backdrop-blur-sm p-4 hover:ring-white/10 shadow-md transition-all duration-300">
            ...
            <section>
              ...
              <div className="space-y-2">
                {data.riskWarnings.map((warning, idx) => (
                  <div key={idx} className="group rounded-xl ring-1 ring-white/5 bg-gradient-to-br from-slate-900/70 to-slate-800/50 backdrop-blur-sm p-3 flex items-center justify-between hover:ring-white/10 transition-all shadow-sm">
                    <div>
